  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Monitor invoices, manage corporate expenses, track balance sheets, and review income metrics."
      />
      <motion.div
        ...
        <Card className="border-dashed border-border/80 bg-card/50 backdrop-blur-md">
          <CardContent className="flex flex-col items-center justify-center py-20 text-center space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-bold tracking-tight">Finance Engine In Development</h3>
              <p className="text-muted-foreground max-w-sm text-sm">
                Advanced features including automated customer invoicing, recurring subscriptions
                integration, multi-currency processing, and tax reporting will be active soon.
              </p>
            </div>
