  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="View real-time workspace updates, compliance warnings, and system alert updates."
      />
      <motion.div
          ...
          <CardContent className="flex flex-col items-center justify-center py-20 text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground max-w-sm text-sm">
                A highly customizable notification center supporting instant browser push alerts,
                email digest scheduling, and team mention hubs is currently being designed.
              </p>
            </div>
