...
export const GET = withApiPermission(
  ...
  async (request: Request, context: any, session: any) => {
    try {
      ...
      // Dynamic Permission: If user lacks crm:manage elevated permission, restrict them to assigned leads
      const hasElevatedAccess = hasPermission(session.user.permissions || [], 'crm', 'manage');
